...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[1] = UserManager.getInstance().createUser(1000, "user1@semanticsquare.com", "test", "Sam", "M", Gender.MALE, UserType.USER);
		users[2] = UserManager.getInstance().createUser(1000, "user2@semanticsquare.com", "test", "Anita", "M", Gender.MALE, UserType.EDITOR);
		users[3] = UserManager.getInstance().createUser(1000, "user3@semanticsquare.com", "test", "Sara", "M", Gender.MALE, UserType.EDITOR);
		users[4] = UserManager.getInstance().createUser(1000, "user4@semanticsquare.com", "test", "Dheeru", "M", Gender.MALE, UserType.CHIEF_EDITOR);
	}
